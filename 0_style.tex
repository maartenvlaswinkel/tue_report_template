...
% Captions
\captionsetup{font={small}, labelfont={bf}, textfont={}, format={plain}, labelsep=space}
...
% Chapter style
\titleformat{\chapter}[display]{\vspace{-1.5em}\normalfont\huge\bfseries}{\LARGE \chaptername \ \thechapter}{0em}{}[\vspace{0.5em}]
...
\titlespacing*{\chapter}{0em}{0em}{-.5\parskip}
\titlespacing*{\section}{0em}{0em}{-.5\parskip}
\titlespacing*{\subsection}{0em}{0em}{-.5\parskip}
\titlespacing*{\subsubsection}{0em}{0em}{-.5\parskip}
...
\fancypagestyle{mainmatter}{
    \fancyhf{}
    \fancyhead[L]{\textit{\nouppercase\leftmark} \vspace{0.05em}}
    \fancyhead[R]{\thepage \vspace{0.05em}}
    \vspace{1em}
    \renewcommand{\headrulewidth}{0.25pt}
    \headsep = 2em
...
\newglossarystyle{symbols}{
    \renewenvironment{theglossary}{
      ...
      \begin{longtable*}{@{\extracolsep{\fill}} l l l}}{\end{longtable*}}
